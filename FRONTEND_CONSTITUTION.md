...
- `components/hub/HubPageComponent.tsx`
- `components/hub/HubSection.tsx`
- `components/hub/HubLinkCard.tsx`
...
- `lib/api/hub.ts` uses `noCache:true`
- `app/hub/[slug]/page.tsx` currently expects revalidation
...
1. unify public visual system around `app/videos/page.tsx`
2. refactor hub
3. refactor library and guestbook
4. split and simplify `app/shares/page.tsx`
5. remove Strapi v4 compat drift
6. replace wildcard populate
7. unify cache strategy
8. remove build debt, debug logs, and stale dependencies
